"""
Health-System Performance & Geographic Equity — Ghana — interactive analytics app (Streamlit + Plotly).
...
st.set_page_config(page_title="Health Systems · Spatial — Ghana", layout="wide", initial_sidebar_state="expanded")

# ---------------- real data ----------------
REGIONS = [
    ("GREATER ACCRA", "Gr.Accra", 78.4, None, "HH"),
    ("ASHANTI", "Ashanti", 72.1, None, "HH"),
    ("CENTRAL", "Central", 61.3, None, "HH"),
    ("EASTERN", "Eastern", 58.9, None, "HH"),
    ("WESTERN", "Western", 55.7, None, "HL"),
    ("VOLTA", "Volta", 52.3, None, "NS"),
    ("OTI", "Oti", 44.1, None, "LH"),
    ("BONO EAST", "Bono E", 48.7, None, "NS"),
    ("AHAFO", "Ahafo", 46.2, None, "NS"),
    ("BONO", "Bono", 50.1, None, "LH"),
    ("WESTERN NORTH", "W.North", 38.4, None, "LL"),
    ("UPPER EAST", "Upper East", 32.1, None, "LL"),
    ("UPPER WEST", "Upper West", 29.8, None, "LL"),
    ("NORTHERN", "Northern", 35.6, None, "LL"),
    ("SAVANNAH", "Savannah", 31.2, None, "LL"),
    ("NORTHERN EAST", "N.East", 30.4, None, "LL"),
]
...
KPIS     = [
    ("78.4", "Highest performance", "Greater Accra"),
    ("29.8", "Lowest performance", "Upper West"),
    ("2.8×", "Disparity ratio", "Accra vs Upper West"),
    ("0.31", "Moran's I", "spatial clustering"),
    ("0.91", "XGBoost AUC", "risk model"),
    ("261", "Districts", "analysed"),
]
...
# ---------------- sidebar ----------------
st.sidebar.title("Health Systems · Spatial — Ghana")
st.sidebar.caption("District health-system performance index & spatial equity · 261 districts")
...
# ---------------- header + KPIs ----------------
st.markdown("### " + "Health-System Performance & Geographic Equity — Ghana")
st.caption("District health-system performance index & spatial equity · 261 districts" + f"  ·  {len(fdf)} of {len(df)} regions in view")
if KPIS:
